...
public class GetOPENGOOGLEPLAY0 extends Requests {

    public GetOPENGOOGLEPLAY0(GooglePlayApiUpdate googlePlayApiUpdate, HashMap<String, String> input) {
    ...
    public HashMap<String, String> make() throws IOException {
        ...
        HashMap<String,byte[]> responseBytes = client.getUp(GET_GOOGLE_PLAY0, body, headers);
